...
/** @defgroup Configuration_Slow_Rate_enumeration **/
typedef enum
{
	GPIO_Slew_Rate_High = 0x00,
	GPIO_Slew_Rate_Low  = 0x01,
...
typedef struct
{
	...
	GPIOSlewRate_TypeDef GPIO_SR;	/*!< Specifies the operating Slew_Rate for the selected pins.
