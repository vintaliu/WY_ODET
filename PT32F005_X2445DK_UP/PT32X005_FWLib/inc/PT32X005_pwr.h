...
#define PWR_PVDLevel_0                  ANAMIX_VDDLVDCTRL_TRIP_1V6
#define PWR_PVDLevel_1                  ANAMIX_VDDLVDCTRL_TRIP_1V7
#define PWR_PVDLevel_2                  ANAMIX_VDDLVDCTRL_TRIP_2V2
#define PWR_PVDLevel_3                  ANAMIX_VDDLVDCTRL_TRIP_2V75
#define PWR_PVDLevel_4                  ANAMIX_VDDLVDCTRL_TRIP_3V5
...
#define PWR_LVDLevel_0                  ANAMIX_LDOLVDCTRL_TRIP_1V35
#define PWR_LVDLevel_1                  ANAMIX_LDOLVDCTRL_TRIP_1V4
#define PWR_LVDLevel_2                  ANAMIX_LDOLVDCTRL_TRIP_1V45

#define IS_PWR_LVD_LEVEL(LEVEL) (((LEVEL) == PWR_LVDLevel_0) || ((LEVEL) == PWR_LVDLevel_1)|| \
                                 ((LEVEL) == PWR_LVDLevel_2))
/**
  * @}
  */	
